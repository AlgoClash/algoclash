...
const CreateRoom = (props) => {
    ...
    return (react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', margin: '1rem' } },
        react_1.default.createElement("h1", { style: { fontFamily: 'monospace', fontSize: '16px' } }, "Create a New Room"),
        ...
        react_1.default.createElement("br", null),
        react_1.default.createElement("br", null),
        react_1.default.createElement("h1", { style: { fontFamily: 'monospace', fontSize: '16px' } }, "Join an Existing Room"),
